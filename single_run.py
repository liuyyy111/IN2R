...
def run():
    ...
    parser.add_argument(
        "--queue_size", default=65536, type=int, help="linear|exponential|sin"
    )
    ...
    parser.add_argument("--i2t", action="store_true", help="Use bidirectional GRU.")
    parser.add_argument("--t2i", action="store_true", help="Use bidirectional GRU.")
    parser.add_argument(
        "--k", default=1, type=int, help="linear|exponential|sin"
    )
    # load arguments
